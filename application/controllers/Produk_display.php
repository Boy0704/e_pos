...
class Produk_display extends CI_Controller
{
    ...
    public function create() 
    {
        ...
        'display_min' => set_value('display_min'),
        'display_max' => set_value('display_max'),
        'stok_gudang' => set_value('stok_gudang'),
    ...
    public function create_action() 
    {
        ...
        'display_min' => $this->input->post('display_min',TRUE),
        'display_max' => $this->input->post('display_max',TRUE),
    ...
    public function update($id) 
    {
        ...
        'display_min' => set_value('display_min', $row->display_min),
        'display_max' => set_value('display_max', $row->display_max),
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $selisih_display = $this->input->post('selisih_display');
            $selisih_gudang = $this->input->post('selisih_gudang');
            $id_subkategori = $this->input->post('id_subkategori');
